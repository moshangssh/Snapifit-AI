...
| 池 | 数量 | 筛选标准 | 用途 |
|----|------|---------|------|
| 新手核心池 | 21 | 机械/哑铃/绳索，排除杠铃/引体/深蹲/硬拉，覆盖 6 肌群 | 新手阶段（0-6 月）主动作 |
...
| 高级扩展池 | 35 | 单侧训练、复杂复合、条件性杠铃（AS 改善后） | 高级阶段（18+ 月）开放 |
| 补充动作 | 10 | 填补覆盖不足（下胸/肩后束/上背/腘绳肌/内收肌/前臂） | 分配到中级/高级池 |

> 2026-06-19 按 #47 后续:`钢索髋关节外展`(钢索引导、无轴向负重、低技术门槛的臀中肌外展)
...
**中级阶段**：
- 保留 10 个基准动作（从新手 21 个中选），追踪长期 PR
- 扩展 30 个变式，提供刺激多样性
